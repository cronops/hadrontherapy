...
\caption[Optional caption for list of figures]{The angular energy distributions with a 27.1~cm (27.9~cm WE) water phantom. Although the yields at small angles seems to be clearly smaller in simulations than in experiments the distribution of energies is a fair match.}
\end{figure}
...
\caption[Optional caption for list of figures]{Fragment yields for 0$^{\circ}$-10$^{\circ}$ angles. Match is fair with experimental data. Especially when considering the large uncertainty reported in the experimental data for heavier fragments.}
\end{figure}
