...
The binary cascade is a hybride cascade model with certain aspects of a quantum mechanical dynamics model. In this model 

The Binary cascade uses a Woods-saxon potential for the nucleon distribution of heavy Ions. Whereas lighter ions are described through a harmonic oscillator nuclear shell model. Almost all ions involved in the simulation in this paper are considered light (A < 16). 
