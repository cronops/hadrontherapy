...
\keywords{Geant4, binary, INCL, Liege cascade, ABLA, CERN, IAEA, Hadrontherapy}
...
The simulation is to be performed with the latest versions of the binary-cascade and ABLA code that is a part of the Geant4 suite.
...
The shape of the results are mosly in line with the experimental data. However, the yields of fragmented fydrogen and surviving carbon ions does not seem to match experimental results.

\begin{figure}[h] 
\begin{center}
\includegraphics[width=0.9\textwidth]{images/fragmentEnergyDistr.png}  
\caption{\label{fig:fragmentEnergyDistr} Fragment energy distribution. Triangles from experimental data, solid bars simulated. Water phantom thickness was 27.9cm (slightly above the Bragg-peak)}
\end{center}
\end{figure}

\subsection{Angulara distribution of fragments}
A detector distance of 298.5cm was used as Haettner describes in figure ... . In the experiment the H1 detector was moved, however, in order to increase effectivness of the simulation circle annuluses were used.
