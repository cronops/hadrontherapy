...
The results are gathered in Appendix C~\ref{fig:fragmentYieldsZeroToTenDegrees}. It is apaprent the match is rather good for most fragments, while outside all margins of error for both Lithium and Helium for almost all phantom depths.
