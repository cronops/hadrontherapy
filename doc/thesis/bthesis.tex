...
Reference data for the measurements involved in this paper have been acquired from GSI and were made by E. Haettner in 2006 as a part of her master's thesis~\cite{ehaettner}. Haettner used two different setups for the measurements; measurements made with the H1 scintillation detector and attenuation measurements made at a shorter distance for calculating the Bragg-curve. In the following parts of this paper recreating these measurements through simulation is discussed. Firstly the required geometries are discussed, and secondly the used methods of picking and analyzing events are presented.
...
1&Beam source window &Aluminum& 0.1mm\\
2&Ionization Chamber 1 &Air-equivalent& 1.4cm\\
3&Adjustable tube window &Plexiglas&2mm\\
4&Phantom &Water& 0-40cm\\
5&Container back-window &Plexiglas&2mm\\
\end{tabular} 
}
\caption[Optional caption for list of figures]{(a) experimental setup for measurements made with the H1 detector. In this paper and the simulation-code the angle denoted by Haettner with $\theta$ is denoted $\phi$. (b) Geometry and elements in water phantom. (c) Legends.}
...
\end{table}
\end{center}
The particle beam shape was set so that measured 0 cm distance scattering of 4mm FWHM was duplicated. When this scattering experiment was repeated for the two other provided measurement points of 1m and 3m results were not in line with those of experimental data. We assumed further scattering not accounted for in the beam must have taken place. To include the added scattering a gaussian shaped stochastical deviation was introduced in the beam's momentum vector. This error was symmetrical in $y$ and $z$ with the magnitude of $.1 \%$ of the x-component. This error was empirically chosen. The results are summarized in table~\ref{fig:beamFWHMtable}.
...
The results and comparison are gathered in appendix~\ref{AppendixB}. The agreement is inbetween rather good for most fragments, the largest deviations from experimental data are viewable for Helium.
