...
The results of beam shape measurements concluded a 3m in air distance to scatter the beam into a 5mm FWHM. This is clearly less than the 9mm measured by E.Haettner.


\subsection{Energy distribution of fragments}
The shape of the results are in line with the experimental data. However, for the lightest fragments the yields seem to be smaller than expected by experimental data.

\begin{figure}[h] 
\begin{center}
\includegraphics[width=0.9\textwidth]{images/fragmentEnergyDistr.png}  
\caption{\label{fig:fragmentEnergyDistr} Fragment energy distribution. Triangles from experimental data, solid bars simulated.}
\end{center}
\end{figure}
