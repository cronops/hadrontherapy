...
\subfigure[Close-up with important measurements]{
\includegraphics[width=0.9\textwidth]{images/haetnnersetup2.png}[h]
}
\label{fig:EHaettnerDataForAEDistrib1}
\subtable[Legends]{
\begin{tabular}{lllll} %fixme: this should be more of a caption
...
%fixme, that's gott be possibly to simplify a bit.
