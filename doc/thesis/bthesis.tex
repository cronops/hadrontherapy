...
\subsubsection{Fermi break-up and fission models}
...
The shape of the results are mostly in line with the experimental data. However, the yields of surviving carbon ions clearly is smaller than that of experimental results. This pheomena is repeated also in other water-depths. Further results are listed in the appendices.
...
\begin{figure}[!h] 
\begin{center}
\includegraphics[width=0.50\textwidth]{images/annulus.png}  
...
The Bragg peak was measured from the simulation data to be located at 26.82 which is a very good match with experimental results.

The greatest difference is the average ioniztion per meter in water, which is about 50 percent larger in the experimental data.
...
\label{fig:subfigureExample}
\caption[Optional caption for list of figures]{he angular distribution plots as described in \cite{AngularDistributionText}. The red triangles represent data from E. Haettner \cite{ehaettner}, and the blue crosses are calculated through the described monte carlo simulation. The worst correlation is for \subref{fig:AD_5.9_1_N}, however E.Haettner notes big uncertainty at shallow phantom depth due to carbon ion interference.}
\end{figure}
\clearpage
