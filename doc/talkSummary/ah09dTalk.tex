...
(\url{http://www-nds.iaea.org/charpar/charpar.htmlx}):
...
Benchmarking platform for the CRP. \\(G.A.P.~Cirrone with G.~Cuttone, F.~Romano, {\em et al.})
\item Suggestion to consider a new Geant4 model INCL in the CRP. (A.~Heikkinen)  
\vspace{0.4cm}
\item {\bf Note from the Japanese team in these slides}
\begin{itemize}
\item Material provided by Takashi Sasaki and Toshiyuki Toshito introduce
the tuning of Geant4 EM models for the best reproduction of the Bragg peak parameters. 
\item Results are based on collaboration between the Japanese team and 
Geant4 EM model developers V.~Ivanchenko and S.~Incerti. 
\end{itemize}
...
\vspace{0.1cm}
\begin{center}
\includegraphics[width=0.96\textwidth]{jp1}
\end{center}
}
...
\vspace{0.1cm}
\begin{center}
\includegraphics[width=0.95\textwidth]{jp3}
\end{center}
}
...
\vspace{0.1cm}
\begin{center}
\includegraphics[width=1.00\textwidth]{jp4}
\end{center}
}
