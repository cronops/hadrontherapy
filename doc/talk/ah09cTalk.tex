...
Alain Boudarad\footnote{CEN-Saclay, CEA-IRFU/SPhN, 91 191 Gif sur Yvette, France}, 
Pekka Kaitaniemi\footnote{CEN-Saclay and Helsinki Institue of Physics}, 
and Gillis Andersson\footnote{Helsinki University of Technology}.
}
...
\begin{itemize}
\item Possibility to use Geant4 fragmantation or
ABLA\footnote{K-H Schmidt, A. Kelic, J. Benlliure GSI and Univ Santiago de C.} 
(new version coming 2009?) evaporation of light clusters and fission dynamics.
...
\item Series of elementary scattering explicitely followed in time.
...
\item All outgoing particles (remnat nucleus, nucleons, pions, no gammas) 
...
\subsection{}
\frame{
\frametitle{INCL: $^{12}$He 135~MeV/A + C \footnote{From \cite{boudard09a}}}
