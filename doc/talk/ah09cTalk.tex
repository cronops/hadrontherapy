...
(new version coming 2009?) de-excitation (evaporation and fission).
...
\subsection{}
\frame{
\frametitle{GSI exeriment: Angular distribution\footnote{Image from~\cite{haettner06a}.}}
...
\subsection{}
\frame{
\frametitle{GSI exeriment: Fragment build-up\footnote{Image from~\cite{haettner06a}.}}
...
\subsection{}
\frame{
\frametitle{GSI exeriment:  Fragment energy\footnote{Image from~\cite{haettner06a}.}}
EXFOR data format will be supported. 
\begin{center}
...
\subsection{}
\frame{
\frametitle{GSI exeriment: Attenuation and Bragg peak\footnote{Image from~\cite{haettner06a}.}}
...
\begin{minipage}{5.5cm}
\begin{itemize}
\item  \href{http://github.com/kaitanie/hadrontherapy/}{Our software} 
is based on exisiting {\bf Hadrontherapy} example and hadron physics {\bf test30} and 
will evolve as Geant4 benchmarking platform for {\em Heavy Charged-Particle
Interaction Data for Radiotherapy.}
\end{itemize}
\end{minipage}
}
...
and others, will participate to compilation and evaluation of 
charged-particle nuclear data for therapeutic applications.

\item We expect to prepare most of the IAEA Geant4 INCL4.3/ABLA benchmarks 
described above before 2010. (6 months)
\begin{itemize}
\item Benchmarks will be repeated when INCL5 is available 2010. (18 months)
\end{itemize}
\item When the platform for agreed IAEA benchmark will have a production quality (6  months)
\begin{itemize}
\item We are prepared to make agreed proton and ions 
benchmarks for relevant Geant4 models. (12 months)
\end{itemize}
