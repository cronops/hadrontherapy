...
\end{itemize}
\todo{Reminder: There is no $\pi N \rightarrow \pi N$, but it is partly taken
...
\todo{Details: based on G4 hadrontherapy example, open source project, public Git repository hosted at GitHub}
