...
\vspace{0.1cm}
Simulation is based on Geant4 hadrontherapy example, 
and \href{http://github.com/kaitanie/hadrontherapy/}{available in open source Git repository}.

\begin{center}
\includegraphics[width=0.55\textwidth]{gsiSetupAngular}
\end{center}
}
...
the Coordinated Research Project (CRP) on Heavy Charged-Particle Interaction Data For Radiotherapy.
\begin{center}
