...
\begin{minipage}{5.5cm}
\begin{itemize}
\item  Our software is based on existing {\bf Hadrontherapy} example (courtesy of INFN-Catania) 
and hadron physics {\bf test30} and 
will evolve as Geant4 benchmarking platform for {\em Heavy Charged-Particle
Interaction Data for Radiotherapy.}

\item Simulation is based on Geant4 hadrontherapy example, 
and \href{http://github.com/kaitanie/hadrontherapy/}{available in open source Git repository}.
\begin{itemize}
\item  Transparent access for non Geant4 members 
\end{itemize}
\end{itemize}
\end{minipage}
}
...
\end{itemize}
\item When the platform for agreed IAEA benchmark will have a production quality (3  months)
\begin{itemize}
